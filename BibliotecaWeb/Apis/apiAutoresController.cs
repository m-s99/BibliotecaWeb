...
namespace BibliotecaWeb.Apis
{
    ...
    [ApiController]
    public class apiAutoresController : ControllerBase
    {
        private readonly smartsof_biblioContext _context;

        public apiAutoresController(smartsof_biblioContext context)
        {
            _context = context;
        }
